    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                people.Push(new Person("Maxim", "Shchukin"));
                people.Push(new Person("Nikita", "Shchukin"));
                people.Push(new Person("Vasiliy", "Pupkin"));
                people.Push(new Person("Aleshka", "Grabovod"));
                Console.WriteLine("Count: " + people.Count);
                Console.WriteLine("Pop: " + people.Pop());
                Console.WriteLine("Count: " + people.Count);
